...
public class LegacySchematic {
	...
	public LegacySchematic(File file) {
		this.file = file;
		this.name = file.getName().split("\\.")[0];
		reload();
	}
	
	public LegacySchematic(File file, String name, List<SchematicEntry> schematicData) {
		this.file = file;
		this.name = name;
	...
	public LegacySchematic(String name, BlockSelection selection, boolean air) {
	...
	private void reload(Consumer<LegacySchematic> future) {
		sizeX = 0;
		sizeY = 0;
		sizeZ = 0;
	...
	public boolean equals(Object obj) {
		return obj instanceof LegacySchematic && name.equals(((LegacySchematic)obj).getName());
	}
